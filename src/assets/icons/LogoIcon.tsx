...
const LogoIcon: React.FC<IconProps> = props => {
  return (
    <svg
      ...
      {...props}
    >
      <rect x="4.5" y="4" width="15" height="16" fill="url(#pattern0_1_1204)" />
      <defs>
        <pattern id="pattern0_1_1204" patternContentUnits="objectBoundingBox" width="1" height="1">
          <use xlinkHref="#image0_1_1204" transform="matrix(0.0169643 0 0 0.015904 0 -0.00892857)" />
        </pattern>
        <image
          id="image0_1_1204"
          width="448"
